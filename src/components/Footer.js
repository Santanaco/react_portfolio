    ...
    <div className="bg-gradient-to-r from-sky-400 via-cyan-300 to-indigo-200 flex space-x-8 text-white">
      ...
      <footer className="flex justify-between">
          ...
          <ul className="flex flex-row justify-between">
            <li><a href="mailto:imanisantana99@gmail.com" title="Email"
              target="_blank" rel="noopener noreferrer">
              <FaEnvelope className="m-3" size={42} />
            </a></li>

            <li><a href="https://github.com/santanaco" title="GitHub Profile"
              target="_blank" rel="noopener noreferrer">
              <FaGithub className="m-3" size={42} />
            </a></li>

            <li><a href="https://www.linkedin.com" title="LinkedIn Profile"
              target="_blank" rel="noopener noreferrer">
              <FaLinkedin className="m-3" size={42} />
            </a></li>

            <li><a href="https://leetcode.com/" title="LeetCode Profile"
              target="_blank" rel="noopener noreferrer">
